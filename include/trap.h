...
#define SAVE_TLB_BADVADDR 0
#define SAVE_TLB_EPC ((SAVE_TLB_BADVADDR) + 4)
#define SAVE_TLB_ENTRYHI ((SAVE_TLB_EPC) + 4)
#define SAVE_TLB_ENTRYLO ((SAVE_TLB_ENTRYHI)  + 4)
#define SAVE_TLB_SP   ((SAVE_TLB_ENTRYLO) + 4)
#define SAVE_TLB_CONTEXT ((SAVE_TLB_SP) + 4)
#define SAVE_TLB_STATUS  ((SAVE_TLB_CONTEXT) + 4)
#define SAVE_TLB_SIZE ((SAVE_TLB_CONTEXT) + 4)
