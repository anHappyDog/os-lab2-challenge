...
static int env_setup_vm(struct Env *e) {
	...
	//challenge
	//just map the pgtable into the Kseg2
	e->env_pgdir[PDX(FASTTLB_PGDIR_ADDRESS)] = PADDR(e->env_pgdir) | PTE_V;
/*	Pte* pte1;
	struct Page* pp = page_lookup(e->env_pgdir,0xc000ffec,&pte1);
	printk("setupvm pp is %08x\n",pp);*/
	return 0;
}
